...
export default function DeleteHarvestModal({ list, harvest }: Props): JSX.Element {
    const { onOpen, isOpen, onOpenChange } = useDisclosure()

    // global states
    const { isDeleting } = harvestStore()

    // custom hooks
    const { deleteHarvest } = useHarvest()
                        ...
                        <>
                            ...
                            <ModalBody className='relative'>
                                ...
                                <div>
                                    ...
                                    <p className='text-center text-sm text-primary'>({`${harvest.nama_kebun}`})</p>
                                </div>
                            </ModalBody>
