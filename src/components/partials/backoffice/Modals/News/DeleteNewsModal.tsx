...
export default function DeleteNewsModal({ news }: Props): JSX.Element {
    const { onOpen, isOpen, onOpenChange } = useDisclosure()

    // global states
    const { isDeleting } = newsStore()
                        ...
                        <>
                            ...
                            <ModalBody className='relative'>
                                ...
                                <div className='space-y-2'>
                                    <p className='text-center'>Apakah kamu yakin menghapus berita ini?</p>

                                    <p className='text-center text-sm text-primary'>({`${news.title}`})</p>
                                </div>
                            </ModalBody>
